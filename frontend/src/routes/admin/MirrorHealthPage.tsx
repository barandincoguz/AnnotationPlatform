...
export function MirrorHealthPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      {confirming && q.data && (
        <div role="dialog" aria-modal="true" aria-labelledby="mirror-requeue-dialog-title" className="fixed inset-0 z-40 bg-black/60 grid place-items-center">
          <div className="bg-card border border-border rounded-lg p-6 max-w-md space-y-3">
            <h2 id="mirror-requeue-dialog-title" className="text-lg font-medium">Onay</h2>
            <p className="text-sm">
