...
const buttonVariants = cva(
  // 4a: bumped icon size 16→20, text 14→15, weight medium→semibold
  // so primary actions feel weighted enough at the new body scale.
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-[15px] font-semibold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        info: 'bg-info text-info-foreground hover:bg-info/90 shadow-sm focus-visible:ring-info',
        warning:
          'bg-warning text-warning-foreground hover:bg-warning/90 shadow-sm focus-visible:ring-warning',
        outline:
